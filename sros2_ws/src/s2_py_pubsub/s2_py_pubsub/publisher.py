...
class PyPublisher(Node):
    ...
    def __init__(self):
        super().__init__('EUCLIDES_py_publisher')
        self.get_logger().info("Python Publisher node has been started")
        self.publisher_ = self.create_publisher(String, 'str_topic', 10)
    ...
    def timer_callback(self):
        msg = String()
        msg.data = 'Hello, this is Eduardo from the Python Publisher on EUCLIDES machine: %d' % self.i
