...
#include <tf2_geometry_msgs/tf2_geometry_msgs.hpp> // tf2_geometry_msgs.h for Foxy, tf2_geometry_msgs.hpp for Humble
#include <cmath>
#include <thread>
#include <chrono>
...
void StatePublisher::publish(){
    ...
    t.transform.translation.y = sin(angle) * 0.5;
    t.transform.translation.z = sin(angle - M_PI / 2) * 0.5 + 0.5;
