...
class PosePublisher(Node):
    def __init__(self):
        ...
        # --- Publishers ---
        self.robot_pub = self.create_publisher(AMRStatus, 'robot_status', 10)
    ...
    def publish(self):
        ...
        status_msg.task_stage = self.stage
        status_msg.pose.x = self.x
        status_msg.pose.y = self.y
        status_msg.pose.theta = self.yaw
